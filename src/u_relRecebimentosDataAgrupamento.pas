unit u_relRecebimentosDataAgrupamento;
...
type
  Tf_relRecebimentosDataAgrupamento = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRBand2: TQRBand;
    QRBand3: TQRBand;
...
var
  f_relRecebimentosDataAgrupamento: Tf_relRecebimentosDataAgrupamento;
...
procedure Tf_relRecebimentosDataAgrupamento.FormCreate(Sender: TObject);
begin
  vLinha:=0;
  vTotal:=0;
end;

procedure Tf_relRecebimentosDataAgrupamento.QRBand3AfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  vLinha:=0;
end;

procedure Tf_relRecebimentosDataAgrupamento.QRBand4AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vTotal:=0;
end;

procedure Tf_relRecebimentosDataAgrupamento.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tf_relRecebimentosDataAgrupamento.QRSubDetail1AfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  vTotal:=vTotal+q_DadosVALORPAGO.Value;
end;

procedure Tf_relRecebimentosDataAgrupamento.QRSubDetail1BeforePrint(
...
procedure Tf_relRecebimentosDataAgrupamento.QRBand2BeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  vLinha:=0;
