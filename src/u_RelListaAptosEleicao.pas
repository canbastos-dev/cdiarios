...
type
  Tf_RelListaAptosEleicao = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRImage1: TQRImage;
    QRLabel2: TQRLabel;
...
var
  f_RelListaAptosEleicao: Tf_RelListaAptosEleicao;
...
procedure Tf_RelListaAptosEleicao.FormCreate(Sender: TObject);
begin
  QRImage1.Picture.LoadFromFile('c:\cdiarios\imagens\logocdiarios.bmp');
end;

procedure Tf_RelListaAptosEleicao.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
