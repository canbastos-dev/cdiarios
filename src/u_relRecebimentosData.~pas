...
type
  Tf_relRecebimentosData = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRBand2: TQRBand;
    QRBand3: TQRBand;
...
var
  f_relRecebimentosData: Tf_relRecebimentosData;
...
procedure Tf_relRecebimentosData.FormCreate(Sender: TObject);
begin
  vLinha:=0;
  vTotal:=0;
end;

procedure Tf_relRecebimentosData.QRBand3AfterPrint(
  Sender: TQRCustomBand; BandPrinted: Boolean);
begin
  vLinha:=0;
end;

procedure Tf_relRecebimentosData.QRBand2BeforePrint(
...
procedure Tf_relRecebimentosData.QRBand4AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vTotal:=0;
end;

procedure Tf_relRecebimentosData.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tf_relRecebimentosData.QRBand2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
