object f_relRecebimentosServicosAgrupamento: Tf_relRecebimentosServicosAgrupamento
  Left = 181
  Top = 104
  Width = 706
  Height = 480
  Caption = 'f_relRecebimentosServicosAgrupamento'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel2: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Resumo do Recebimento Academia no Per'#237'odo'
        Color = clWhite
        Transparent = False
        WordWrap = True
        FontSize = 10
    ...
    object QRBand2: TQRBand
      ...
      object qrlTotVlrClube: TQRLabel
        Left = 599
        Top = 0
        Width = 58
        Height = 17
      ...
      object qrlTotVlrParceiro: TQRLabel
        Left = 671
        Top = 0
        Width = 74
        Height = 17
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      object qrlVlrParceiro: TQRLabel
        Left = 672
        Top = 2
        Width = 71
        Height = 17
  ...
  object q_Dados: TADOQuery
    ...
    SQL.Strings = (
      ...
      'WHERE '
        ...
        'ADRAO=:d3 and MENSPGCLUBE=9 AND ATIVO='#39'S'#39
      'order by'
      '  DTPAGAMENTO')
    Left = 137
    Top = 200
  ...
  object q_Descricoes: TADOQuery
    ...
    SQL.Strings = (
      ...
      'WHERE '
        ...
        '  DTPAGAMENTO BETWEEN :d1 AND :d2 AND IDFORMAPAG<900 and MENSPGC' +
        'LUBE=9  AND ATIVO='#39'S'#39
      'group by'
